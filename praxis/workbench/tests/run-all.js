...
var files = ['utils.test.js', 'migration.test.js', 'derive.test.js', 'alerts.test.js', 'track.test.js', 'screen.test.js', 'prescan.test.js', 'firstreview.privacy.test.js', 'demo-screens.test.js'];
var failed = false;
